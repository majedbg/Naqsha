...
// Behavioral spec for RecursiveGeometry's WARP modulation. A guide field
// (channel: 'warp') displaces the recursive polygon vertices along the field
// gradient at geometry-build time, after the full recursion, before both emits.
// The geometry is origin-centered, so the unit-domain mapping uses canvasW/2.
// Off the warp path, output is byte-identical to the unmodulated pattern.
...
// RecursiveGeometry's own SVG formatter: toFixed(2).
...
describe("RecursiveGeometry warp modulation", () => {
